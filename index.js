...
app.get('/js/simple-fixes.js', (req, res) => {
  res.sendFile(path.join(__dirname, 'src/js/simple-fixes.js'))
});

app.get('/js/simple-metamask.js', (req, res) => {
  res.sendFile(path.join(__dirname, 'src/js/simple-metamask.js'))
});
...
app.get('/css/admin-fixed.css', (req, res) => {
  res.sendFile(path.join(__dirname, 'src/css/admin-fixed.css'))
});
...
app.get('/dist/voter.bundle.js', (req, res) => {
  res.sendFile(path.join(__dirname, 'src/dist/voter.bundle.js'));
});
